...
<?php if(session()->get('level')==1){
 ?>
                        ...
                        <?php } ?>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/lost_item') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Barang Hilang</span></a></li>
